...
|------|---------------|-----------------|----------|
| **Free (BYOK)** | $0 | Bring Your Own Keys | Developers with API keys |
| **Pro** | $15 | 7.5M tokens | Individual developers |
| **Pro+** | $25 | 12.5M tokens | Teams & Professional developers |
| **Max** | $99 | 50M tokens | Agencies, Startups & power users |

> **Note**: Free plan requires you to bring your own API keys and does not include preview access.

### Estimated Usage Capacity

Based on real-world usage patterns, here's roughly what you can accomplish with each plan:

| Plan | AI Interactions | Simple Frontend Projects | Complex Full-Stack Projects |
|------|----------------|-------------------------|----------------------------|
| **Pro** | ~5,000 | ~50-70 projects | ~20-30 projects |
| **Pro+** | ~8,400 | ~85-120 projects | ~35-50 projects |
| **Max** | ~33,200 | ~330-470 projects | ~140-200 projects |

> **Note**: Simple projects = frontend-only apps without backend, services, or complex integrations. Full-stack projects = complete applications with backend, database, auth, APIs, etc.
...
- GLM 4.6, Gemini 2.5 Pro, Kimi K2 Thinking
- Flutter, React, and Svelte environments
- GitHub integration
- Vision & web search
...
**Pro+ - $25/month**
- **~12.5M tokens/month**
- ~8,400 AI interactions per month
- Delegate your coding tasks
- GLM 4.6, Gemini 2.5 Pro, Kimi K2 Thinking
- Flutter, React, and Svelte environments
- GitHub integration
...
**Max - $99/month**
- **~59M tokens/month**
- ~33,200 AI interactions per month
- Delegate your coding tasks
- **Claude Sonnet/Opus**, GLM 4.6, Gemini 2.5 Pro, Kimi K2 Thinking
- Flutter, React, and Svelte environments
- GitHub integration
- Vision & web search
- Create custom agents
...
> *Gemini 2.0 is available with very generous limits as a free bonus
