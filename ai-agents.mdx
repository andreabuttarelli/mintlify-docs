...
3. Fill in the agent details:
   - **Name**: A descriptive name (e.g., "react-best-practices", "flutter-clean-arch")
...
- Keep components reactive and simple
...
```markdown
For every function/component, generate documentation:
- Description of purpose
- Parameter/props explanations
- Return values
- Example usage
