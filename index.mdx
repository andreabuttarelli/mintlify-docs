...
Teta is an AI-powered development platform that supports **Flutter, React, and Svelte** development. Build mobile, web, and desktop applications with the power of AI while maintaining full control over your code through GitHub. With an integrated **cloud VS Code environment**, you can code, collaborate, and control your projects from anywhere.

## Key Features

### 🤖 AI Optimized for Modern Frameworks
- **Multi-Framework Support**: AI optimized for Flutter, React, and Svelte development
- **Cloud Environment**: Pre-configured development environments with all necessary SDKs and tools
- **Intelligent Assistant**: AI that understands framework-specific patterns, state management, and best practices
...
- **Hot Reload**: Instant UI updates without rebuilding (Flutter, React, Svelte)
- **Hot Restart**: Quick app restarts for logic changes (Flutter)
...
- **Full IDE in the Cloud**: Access a complete VS Code instance directly from your browser
- **Extensions Support**: Install and use your favorite VS Code extensions
- **Direct Code Control**: Edit, review, and modify code with precision
- **Real-Time Collaboration**: Work together with your team in the same environment
- **Terminal Access**: Run commands, tests, and scripts directly in the cloud
- **Seamless Integration**: Switch between AI assistance and manual coding effortlessly
...
2. Choose your project type: **Flutter**, **React**, or **Svelte**
...
- 💻 [Cloud VS Code Environment](./cloud-vscode.md) - Learn how to use the integrated IDE
